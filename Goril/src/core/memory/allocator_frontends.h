...
#define Realloc(allocator, block, newSize) allocator->BackendRealloc(allocator, block, size)
// void Free(Allocator* allocator, void* block);
#define Free(allocator, block) allocator->Backend->Free(allocator, block);
...
// ================================== Global allocator (not an allocator type) =================================================================================================================================================
