...
bool EndSubmitAndFreeSingleUseCommandBuffer(CommandBuffer* commandBuffer, u32 signalSemaphoreCount = 0, VkSemaphoreSubmitInfo* pSemaphoreSubmitInfos = nullptr, u64* out_signaledValue = nullptr);
