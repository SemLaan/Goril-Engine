...
bool CreateGraphicsPipeline()
{
    ...
    for (i32 i = 0; i < MAX_FRAMES_IN_FLIGHT; ++i)
    {
        descriptorSetLayouts[i] = vk_state->descriptorSetLayout;
    }
...
#define VERTEX_ATTRIBUTE_COUNT 8
	...
	/*for (u32 i = 0; i < MAX_FRAMES_IN_FLIGHT; ++i)
    {
        ...
        descriptorImageInfo.sampler = NULL;
        descriptorImageInfo.imageView = NULL;
        descriptorImageInfo.imageLayout = VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL;

        VkWriteDescriptorSet descriptorWrites[2] = {};
        descriptorWrites[0].sType = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
        descriptorWrites[0].pNext = nullptr;
        descriptorWrites[0].dstSet = vk_state->uniformDescriptorSetsDarray[i];
        ...
        descriptorWrites[1].dstSet = vk_state->uniformDescriptorSetsDarray[i];
