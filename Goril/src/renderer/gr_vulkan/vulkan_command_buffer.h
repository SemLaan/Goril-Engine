...
bool EndSubmitAndFreeSingleUseCommandBuffer(CommandBuffer* commandBuffer, u32 signalSemaphoreCount, VkSemaphoreSubmitInfo* pSemaphoreSubmitInfos, u64* out_signaledValue);
